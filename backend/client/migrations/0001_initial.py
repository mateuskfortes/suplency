    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grupos', models.ManyToManyField(blank=True, related_name='users', related_query_name='user', to='auth.group')),
                ('permissoes', models.ManyToManyField(blank=True, related_name='users', related_query_name='user', to='auth.permission')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('focus_time', models.DurationField(default=datetime.timedelta(seconds=2400))),
                ('break_time', models.DurationField(default=datetime.timedelta(seconds=600))),
                ('rest_time', models.DurationField(default=datetime.timedelta(seconds=1800))),
